# Graph Report - dmtcode  (2026-09-10)

## Corpus Check
- 609 files · ~861,099 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3488 nodes · 7523 edges · 284 communities (186 shown, 98 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 24 edges (avg confidence: 0.61)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `491bbeb4`
- Run `git rev-parse HEAD` and compare to check if the graph is stale.
- Run `graphify update .` after code changes (no API cost).

## Community Hubs (Navigation)
- Communities (280 total, 98 thin omitted)
- card.tsx
- AppRoutes.tsx
- CardHeader
...
- devDependencies
- Graph Report - dmtcode  (2026-09-09)
- renderArticleDetail
- entries
...
- admin-translate-submission/index.ts
...
- datesIn
- get
- forecasts-export/index.ts
- forecasts-proxy/index.ts
- ga4-test-event/index.ts
- posthog-analytics/index.ts
- rate-limit-check/index.ts
- share-assessment/index.ts
- text-to-speech/index.ts
- transcribe-voice/index.ts

## God Nodes (most connected - your core abstractions)
1. `Communities (280 total, 98 thin omitted)` - 171 edges
2. `cn()` - 150 edges
3. `Button` - 144 edges
4. `supabase` - 133 edges
5. `Card` - 106 edges
6. `Badge()` - 95 edges
7. `Navigation()` - 78 edges
8. `Footer()` - 73 edges
9. `Breadcrumb()` - 52 edges
...
- `useTagVocabulary()` --indirect_call--> `tag()`  [INFERRED]
  src/hooks/useTagVocabulary.ts → supabase/functions/scrape-articles/index.ts
- `LocalizedBody()` --references--> `dompurify`  [EXTRACTED]
  src/components/LocalizedBody.tsx → package.json
...
### Community 0 - "Communities (280 total, 98 thin omitted)"
Cohesion: 0.01
Nodes (171): Communities (280 total, 98 thin omitted), Community 0 - "Communities (273 total, 98 thin omitted)", Community 100 - "menubar.tsx", Community 101 - "Articles.tsx", Community 102 - "calculate-cascade/index.ts", Community 103 - "trends-ingest/index.ts", Community 104 - "Graph Report - dmtcode  (2026-09-08)", Community 105 - "devDependencies" (+163 more)

### Community 1 - "card.tsx"
Cohesion: 0.05
Nodes (60): ArticleCard(), formatDate(), PreviewArticle, Props, AnalyticsData, BundleAnalytics(), BundleMetric, FunnelStep (+52 more)

### Community 2 - "AppRoutes.tsx"
Cohesion: 0.03
Nodes (56): Analysis, ApiSymbols, ArticleDetail, Articles, AssessmentPage, Capture, CoWitnesses, Dashboard (+48 more)

### Community 3 - "CardHeader"
Cohesion: 0.08
Nodes (46): ApiLog, Check, ContentAuditor(), describeError(), isProductionHost(), probe(), runChecks(), SurfaceResult (+38 more)

### Community 4 - "content-prerender.ts"
Cohesion: 0.04
Nodes (54): API_CATALOG_LD, BREADCRUMB_LD_DANNY_GOLER, config, DATASET_PAGE_LD, DOC_LANG_TAG, docListHtml(), EV_VER_LABELS, FAQ_GROUPS (+46 more)

### Community 5 - "Navigation.tsx"
Cohesion: 0.14
Nodes (20): Breadcrumb(), Footer(), LocalizedBody(), Logo(), LogoProps, Navigation(), SEO(), EventRow (+12 more)

### Community 6 - "useLocale"
Cohesion: 0.09
Nodes (41): FollowButton(), FollowButtonProps, FollowEntityType, GolerAttribution(), LABELS, LanguageSwitcher(), MegaMenu(), fetchTranslations() (+33 more)

### Community 7 - "Theories.tsx"
Cohesion: 0.08
Nodes (31): ChangelogEntry, FalsificationCriterion, Forecast, ForecastChangelog(), MarketDisagreement, EmailCaptureProps, EventSubmissionModalProps, TrialSubmissionModalProps (+23 more)

### Community 8 - "AdminDashboard.tsx"
Cohesion: 0.06
Nodes (35): AdminNotifications(), Notification, ApiAccessLog(), BibliographyReviewQueue(), Filter, FILTERS, Row, DoorTapsPanel() (+27 more)

### Community 9 - "CartDrawer.tsx"
Cohesion: 0.07
Nodes (36): BundleUpsell(), BundleUpsellProps, JOURNAL_DISCOUNT_BUNDLE, PROTOCOL_STARTER_BUNDLE, Window, CartDrawer(), KIT_HANDLES, Window (+28 more)

### Community 10 - "hooks/use-toast.ts"
Cohesion: 0.08
Nodes (36): AdjustedEvent, buildDependencyRulesMap(), decodeAdjustments(), encodeAdjustments(), getCurrentQuarterNumeric(), getShortName(), medianToNumeric(), numericToMedian() (+28 more)

### Community 11 - "utils.ts"
Cohesion: 0.09
Nodes (30): CommunityNotesProps, Note, emptyToNull(), PreregistrationForm(), preregistrationSchema, PreregistrationValues, DOSE_LEVELS, formSchema (+22 more)

### Community 12 - "MySymbols.tsx"
Cohesion: 0.08
Nodes (33): Pending, RunRow, TrialsBackfillPanel(), BadgeIcon, BadgeIconName, BadgeIconProps, MARKS, clamp01() (+25 more)

### Community 13 - "button.tsx"
Cohesion: 0.08
Nodes (20): glyphs, ContextTermPicker(), ContextTermPickerProps, VocabTerm, CommunityTag, Props, ErrorBoundaryFallbackProps, TopSymbol (+12 more)

### Community 14 - "Home.tsx"
Cohesion: 0.07
Nodes (24): EmailCapture(), ExplainerSection(), HeroSection(), ConvergenceHero(), ExpeditionStrip(), STEPS, GetInvolvedDoors(), Props (+16 more)

### Community 15 - "badge.tsx"
Cohesion: 0.07
Nodes (27): ArticleLeadsQueue(), Filter, FILTERS, Row, Sort, SORTS, Product, ProductModeration() (+19 more)

### Community 16 - "machine-truth-parity.mjs"
Cohesion: 0.06
Nodes (29): APPROVAL_FIRST, badStatus, BIB_TYPES, bibRows, BLANKET_POWER, clinicalNonReg, DOC_FILES, fails (+21 more)

### Community 17 - "Profile.tsx"
Cohesion: 0.08
Nodes (29): HighFivesReceived(), Row, ActivityThread(), Entry, firstWords(), Entry, Following(), FollowRow (+21 more)

### Community 18 - "SubmissionWizard.tsx"
Cohesion: 0.08
Nodes (24): CanvasErrorBoundary, pickCanvasSize(), SymbolCanvas(), SymbolCanvasProps, SymbolMetadata, Step, StepIndicator(), StepIndicatorProps (+16 more)

### Community 19 - "client.ts"
Cohesion: 0.10
Nodes (22): AdminDashboard(), RegistrySymbol, SymbolModeration(), ProtectedRoute(), Tag, TagsManagerProps, RateLimitResponse, RoleState (+14 more)

### Community 20 - "esc"
Cohesion: 0.20
Nodes (34): buildHead(), clip(), esc(), getRow(), jsonLd(), NO_TRANSLATION_UNDER_LOCALE, notFound404(), notFoundPrerender() (+26 more)

### Community 21 - "Bibliography.tsx"
Cohesion: 0.13
Nodes (27): BibliographyCard(), displayDate(), Props, stanceLabel(), BibliographyFilters(), Props, FilterGuide(), Props (+19 more)

### Community 22 - "InteractiveTimeline.tsx"
Cohesion: 0.11
Nodes (29): ConfidenceTier, ConfidenceTierFilters(), ConfidenceTierFiltersProps, tiers, CriticalPathTimeline(), CriticalPathTimelineProps, getCategoryColor(), QUARTER_OPTIONS (+21 more)

### Community 23 - "LayeredSubmissionForm.tsx"
Cohesion: 0.08
Nodes (24): CanvasExport(), CanvasExportProps, FabricCanvasProps, FabricDrawingCanvas(), FormData, GlyphAnnotation, LayeredSubmissionForm(), LayeredSubmissionFormProps (+16 more)

### Community 24 - "intel-snapshot/index.ts"
Cohesion: 0.11
Nodes (26): corsHeaders, RANGES, corsHeaders, countRows(), crawlerMetric(), Ctx, cumulativePair(), dayKey() (+18 more)

### Community 25 - "dialog.tsx"
Cohesion: 0.13
Nodes (22): fmtWhen(), FunnelDrilldown(), Group, Props, TherapistShareModalProps, CoWitnessInviteDialog(), Props, trackGA() (+14 more)

### Community 26 - "forecasts-api.ts"
Cohesion: 0.13
Nodes (25): ApiDocumentation(), ExportButtons(), ExportButtonsProps, IntroductionAccordion(), MethodologyAccordionProps, formatParadigmContent(), ParadigmDefensePanel(), ParadigmDefensePanelProps (+17 more)
...
### Community 28 - "WhatIfSliderPanel.tsx"
Cohesion: 0.12
Nodes (22): WhatIfSimulatorV2(), WhatIfSimulatorV2Props, AdjustedEventData, decodeAdjustments(), encodeAdjustments(), getCurrentQuarterNumeric(), getShortName(), medianToNumeric() (+14 more)

### Community 29 - "Prepare.tsx"
Cohesion: 0.13
Nodes (24): DOC_FILE_COUNT, DOC_NUMBER_WORDS, DOC_PATH(), docCountWord(), DocFile, DocLang, DocRecord, DOCUMENTS (+16 more)

### Community 30 - "translate-content/index.ts"
Cohesion: 0.09
Nodes (22): callTimeoutMs(), Cfg, CONFIG, Cursor, DeadlineError, extractMarked(), gateSql(), GatewayPausedError (+14 more)

### Community 31 - "lib/kits.ts"
Cohesion: 0.07
...
### Community 33 - "Trials.tsx"
Cohesion: 0.15
Nodes (20): formatApprox(), formatMonthYear(), MONTHS, MONTHS_SHORT, isRegisteredClinicalTrial(), isRegisteredStudy(), LABELS, needsVerificationBadge() (+12 more)
...
### Community 37 - "4. ✅ Alt-Text Pattern for All Glyphs"
Cohesion: 0.08
...
Cohesion: 0.17
Nodes (17): ComparisonItem, formatDate(), getComparisonIcon(), getEventId(), getEventMarketData(), MarketComparisonSection(), MarketComparisonSectionProps, ProcessedEvent (+9 more)

### Community 44 - "cn"
Cohesion: 0.14
Nodes (18): ListRow(), ListRowProps, toneClass, ButtonProps, buttonVariants, Calendar(), CalendarProps, Pagination() (+10 more)

### Community 45 - "IntelHub.tsx"
Cohesion: 0.13
...
### Community 47 - "TrialDetailModal.tsx"
Cohesion: 0.14
Nodes (13): CommunityNotes(), Event, EventDetailModalProps, ICalExport(), ICalExportProps, SocialShare(), SocialShareProps, ClinicalTrial (+5 more)

### Community 48 - "entry"
Cohesion: 0.11
Nodes (19): definitions, entry, place, source, additionalProperties, allOf, description, type (+11 more)
...
### Community 59 - "DMTCode — Essence & Experience Audit Handoff"
Cohesion: 0.12
...
### Community 62 - "ArticlesManager.tsx"
Cohesion: 0.15
Nodes (15): ArticlePublishPreview(), Article, ArticleLead, ArticlesManager(), ArticleStatus, Draft, EMPTY_DRAFT, formatArticleDate() (+7 more)

### Community 63 - "MembersDirectory.tsx"
Cohesion: 0.18
Nodes (14): ACTIVITY_LABEL, activityState, ageInDays(), csvCell(), FilterKey, formatJoined(), formatMembershipAge(), formatRelative() (+6 more)

### Community 64 - "SymbolDetail.tsx"
Cohesion: 0.21
...
### Community 65 - "EventsTimeline.tsx"
Cohesion: 0.18
Nodes (15): Event, EventsTimeline(), fmt(), formatRange(), Props, FestivalCard(), paragraphs(), EVENT_RELEVANCE (+7 more)

### Community 66 - "DependencyRule"
Cohesion: 0.17
Nodes (14): CRITICAL_CHAIN, DependencyGraphD3(), DependencyGraphD3Props, GraphLink, GraphNode, EventDetailPanel(), EventDetailPanelProps, ScenarioInputPanelProps (+6 more)

### Community 67 - "tagLabel"
Cohesion: 0.22
Nodes (12): RecentContributions(), RecentSymbol, RegistryFilters(), SymbolCard(), SymbolCardProps, isRenderableImage(), TAG_LABELS, tagLabel() (+4 more)

### Community 68 - "cronAuth.ts"
Cohesion: 0.18
...
### Community 69 - "sync-llms-kits.mjs"
Cohesion: 0.15
Nodes (10): block, buildBlock(), buildSellerLine(), env, kits, kitWavelengths(), observerPhrase(), TENS (+2 more)

### Community 70 - "AvatarGlyph.tsx"
Cohesion: 0.21
Nodes (12): AvatarGlyph(), AvatarGlyphProps, AvatarToastListener(), CoWitness, CoWitnessModule(), formatContext(), Props, trackGA() (+4 more)

### Community 71 - "skeleton.tsx"
Cohesion: 0.16
Nodes (11): formatLocation(), RetreatCard(), Retreat, TrialDetailModal(), ClinicalTrial, statusColors, TrialsTimeline(), SharedTimeline() (+3 more)

### Community 72 - "useModeStore"
Cohesion: 0.17
Nodes (11): GrainOverlay(), LaserDivider(), LaserDividerProps, ModeToggle(), KIT_PRICE_RANGE, MetaConfig, pageMetaConfig, useDynamicMeta() (+3 more)

### Community 73 - "Dataset.tsx"
Cohesion: 0.20
...
### Community 74 - "renderStatic"
Cohesion: 0.19
Nodes (15): evVerLabel(), getTranslations(), getTranslationsBulk(), golerAttribution(), HASH_GATED_STATIC_PAGES, liveCountsHtml(), localizedProtocolGuideLd(), lpath() (+7 more)

### Community 75 - "data-json.ts"
Cohesion: 0.13
...
### Community 77 - "hydration-parity.mjs"
Cohesion: 0.24
Nodes (14): BASE, check(), failures, flat(), has(), ldTypes(), norm(), rawH1() (+6 more)

### Community 78 - "App.tsx"
Cohesion: 0.18
Nodes (9): App(), GA4Tracker(), queryClient, AppRoutes(), BadgeToastListener(), HighFiveToastListener(), useGA4PageTracking(), Window (+1 more)

### Community 79 - "MarketOverlayTimeline.tsx"
Cohesion: 0.22
Nodes (14): dateToPosition(), getBarSpread(), getTimelinePosition(), MARKET_EVENT_MAPPING, MarketOverlayTimeline(), MarketOverlayTimelineProps, matchEventName(), matchMarketPredictions() (+6 more)

### Community 80 - "RelatedBundleProducts.tsx"
Cohesion: 0.14
...
### Community 81 - "scrape-festivals/index.ts"
Cohesion: 0.20
Nodes (14): BROWSER_HEADERS, corsHeaders, first(), Found, fromJsonLd(), fromText(), iso(), JsonLdExtras (+6 more)

### Community 82 - "api-v1.ts"
Cohesion: 0.18
Nodes (10): BIB_TYPES, config, Corpus, DECLARED_FIELDS, ENDPOINTS, json(), openapi(), Row (+2 more)

### Community 83 - "tags"
Cohesion: 0.14
Nodes (14): description, items, minItems, type, minLength, pattern, type, authors (+6 more)

### Community 84 - "CoWitnessSettings.tsx"
Cohesion: 0.22
Nodes (10): CoWitnessSettings(), Prefs, Visibility, ALIGNMENT_OPTIONS, AlignmentBranch, ScenarioToggles(), ScenarioTogglesProps, RadioGroup (+2 more)

### Community 85 - "SaveButton.tsx"
Cohesion: 0.22
Nodes (10): SaveButton(), SaveButtonProps, TagsManager(), MetadataForm(), useDashboardTracking(), Window, useSaveSymbol(), useTagVocabulary() (+2 more)

### Community 86 - "Events.tsx"
Cohesion: 0.18
Nodes (11): ActiveTrialsList(), Trial, EventSubmissionModal(), FestivalsList(), RetreatSubmissionModal(), TrialSubmissionModal(), Event, UpcomingEventsList() (+3 more)

### Community 87 - "WhatIfTimeline.tsx"
Cohesion: 0.21
Nodes (11): ScenarioInputPanel(), findEvent(), getTimelinePosition(), ProcessedShiftedEvent, WhatIfTimeline(), WhatIfTimelineProps, YEARS, ShiftedEvent (+3 more)

### Community 88 - "MegaMenu.tsx"
Cohesion: 0.19
...
### Community 89 - "useSymbolVoting.tsx"
Cohesion: 0.19
Nodes (11): DidNotMatchButton(), DidNotMatchButtonProps, SimilarButton(), SimilarButtonProps, VotingButtons(), ALL_VOTE_TYPES, UserVotes, useSymbolVoting() (+3 more)
...
### Community 91 - "Auth.tsx"
Cohesion: 0.20
Nodes (10): Separator, UserDropdown(), AuthProvider, useAuthTracking(), Window, lovable, lovableAuth, SignInOptions (+2 more)

### Community 92 - "GuideDetail.tsx"
Cohesion: 0.25
Nodes (12): asEntries(), asRelated(), asStrings(), EvidenceList(), formatDate(), Guide, GuideDetail(), hasText() (+4 more)

### Community 93 - "Accessibility Audit Completed"
Cohesion: 0.14
...
### Community 94 - "route-verify/index.ts"
Cohesion: 0.18
...
### Community 98 - "title"
Cohesion: 0.15
Nodes (13): description, maxLength, minLength, type, headline, text, title, minLength (+5 more)

### Community 99 - "carousel.tsx"
Cohesion: 0.15
...
### Community 101 - "Structural audit items: plan"
Cohesion: 0.17
...
### Community 103 - "check-docs-drift.mjs"
Cohesion: 0.18
...
### Community 105 - "UserDropdown.tsx"
Cohesion: 0.21
...
Cohesion: 0.18
Nodes (11): autoprefixer, eslint-plugin-react-refresh, devDependencies, autoprefixer, eslint-plugin-react-refresh, postcss, @types/react, vite (+3 more)

### Community 110 - "Graph Report - dmtcode  (2026-09-09)"
Cohesion: 0.18
Nodes (10): Community Hubs (Navigation), Corpus Check, God Nodes (most connected - your core abstractions), Graph Freshness, Graph Report - dmtcode  (2026-09-09), Import Cycles, Knowledge Gaps, Suggested Questions (+2 more)

### Community 111 - "renderArticleDetail"
Cohesion: 0.18
Nodes (11): fetchInList(), FIGURE_ATTRS, FIGURE_TAGS, humanizeKey(), mdToHtml(), mdToPlain(), renderArticleDetail(), sanitizeFigure() (+3 more)

### Community 112 - "entries"
Cohesion: 0.18
Nodes (11): description, items, minItems, type, $ref, description, items, minItems (+3 more)

### Community 113 - "Scale Preparation - Production Ready"
Cohesion: 0.18
...
### Community 114 - "kit-pick-list.mjs"
Cohesion: 0.20
...
### Community 116 - "TimelineVisualization.tsx"
Cohesion: 0.33
...
### Community 120 - "spa-guard.ts"
Cohesion: 0.22
Nodes (8): config, isDetailPatternValid(), isNullishId(), LEGAL_COUNTRIES, NULLISH_ID, PRODUCT_HANDLES, NOTE: the legal and for-agents segments are deliberately absent. The events, VALID_FIRST_SEGMENT
...
Cohesion: 0.20
Nodes (10): required, required, date, evidence_class, headline, id, source, summary (+2 more)

### Community 123 - "enum"
Cohesion: 0.20
Nodes (10): enum, type, kind, court_opinion, database_record, journal_article, letters_article, news_article (+2 more)

### Community 124 - "HorizontalBarTimeline.tsx"
Cohesion: 0.29
Nodes (8): getCategoryColor(), HorizontalBarTimeline(), QUARTER_OPTIONS, PinchZoomConfig, PinchZoomHandlers, PinchZoomState, usePinchZoom(), UsePinchZoomReturn

### Community 125 - "RegistryBrowser.tsx"
Cohesion: 0.27
Nodes (8): hasAnyTag(), NULL_REPORT_TAGS, ProfileData, RegistryBrowser(), SOBER_TAGS, SymbolSubmission, useRegistryTracking(), Window

### Community 126 - "chart.tsx"
Cohesion: 0.20
Nodes (7): ChartConfig, ChartContainer, ChartContext, ChartContextProps, ChartLegendContent, ChartTooltipContent, THEMES

### Community 127 - "context-menu.tsx"
Cohesion: 0.20
Nodes (9): ContextMenuCheckboxItem, ContextMenuContent, ContextMenuItem, ContextMenuLabel, ContextMenuRadioItem, ContextMenuSeparator, ContextMenuShortcut(), ContextMenuSubContent (+1 more)

### Community 128 - "articleJsonLd.ts"
Cohesion: 0.24
Nodes (9): ArticleLdInput, ArticleLdResult, buildArticleLd(), clip(), DEFAULT_OG_IMAGE, LICENSE, mdToPlain(), RichResultNote (+1 more)

### Community 129 - "assess-score/index.ts"
Cohesion: 0.20
Nodes (5): CEQ7_QUESTIONS, corsHeaders, GAD7_QUESTIONS, MEQ4_QUESTIONS, PHQ9_QUESTIONS

### Community 130 - "lib/documents.ts"
Cohesion: 0.22
Nodes (7): DOC_FILE_COUNT, DOC_NUMBER_WORDS, docCountWord(), DocFile, DocLang, DocRecord, DOCUMENTS

### Community 131 - "country"
Cohesion: 0.22
Nodes (9): description, pattern, type, description, minLength, type, properties, country (+1 more)

### Community 132 - "route_parity.py"
Cohesion: 0.28
...
### Community 145 - "Welcome to your Lovable project"
Cohesion: 0.29
...
### Community 165 - "symbols/manifest.json"
Cohesion: 0.40
Nodes (4): generated, license_note, set, symbols

### Community 166 - "PWAInstallPrompt.tsx"
Cohesion: 0.60
Nodes (3): PWAInstallPrompt(), BeforeInstallPromptEvent, usePWAInstall()

### Community 167 - "input-otp.tsx"
Cohesion: 0.40
Nodes (4): InputOTP, InputOTPGroup, InputOTPSeparator, InputOTPSlot

### Community 168 - "sonner.tsx"
Cohesion: 0.40
Nodes (3): accessibleToast, Toaster(), ToasterProps

### Community 169 - "glossaryTerms.ts"
Cohesion: 0.40
Nodes (4): GlossaryTerm, terms, termSlug(), Glossary()

### Community 170 - "useInventoryStatus.tsx"
Cohesion: 0.50
Nodes (4): InventoryStatus, slugToProductMapping, useInventoryStatus(), useSingleInventoryStatus()

### Community 172 - "notify-admin/index.ts"
Cohesion: 0.50
Nodes (4): corsHeaders, escapeHtml(), handler(), NotificationRequest

### Community 173 - "lib/ui-strings.ts"
Cohesion: 0.50
Nodes (3): HUB_LABELS, Loc, UI_STRINGS

### Community 175 - "avatar.tsx"
Cohesion: 0.50
Nodes (3): Avatar, AvatarFallback, AvatarImage

### Community 177 - "productImages.ts"
Cohesion: 0.67
Nodes (3): getProductImage(), getProductImageWithFallback(), productImageMap

## Knowledge Gaps
- **1602 isolated node(s):** `$schema`, `style`, `rsc`, `tsx`, `config` (+1597 more)
...
- **Why does `dependencies` connect `dependencies` to `react`, `package.json`, `class-variance-authority`, `clsx`, `cmdk`, `d3`, `date-fns`, `dompurify`, `embla-carousel-react`, `fabric`, `@hookform/resolvers`, `i18next-browser-languagedetector`, `input-otp`, `lucide-react`, `next-themes`, `@radix-ui/react-accordion`, `@radix-ui/react-alert-dialog`, `@radix-ui/react-aspect-ratio`, `@radix-ui/react-avatar`, `@radix-ui/react-checkbox`, `@radix-ui/react-collapsible`, `@radix-ui/react-context-menu`, `@radix-ui/react-dialog`, `@radix-ui/react-dropdown-menu`, `@radix-ui/react-hover-card`, `@radix-ui/react-label`, `@radix-ui/react-menubar`, `@radix-ui/react-navigation-menu`, `@radix-ui/react-popover`, `@radix-ui/react-progress`, `@radix-ui/react-radio-group`, `@radix-ui/react-scroll-area`, `@radix-ui/react-select`, `@radix-ui/react-separator`, `@radix-ui/react-slider`, `@radix-ui/react-slot`, `@radix-ui/react-switch`, `@radix-ui/react-tabs`, `@radix-ui/react-toast`, `@radix-ui/react-toggle-group`, `@radix-ui/react-tooltip`, `react-day-picker`, `react-dom`, `react-helmet`, `react-i18next`, `react-markdown`, `react-resizable-panels`, `react-router-dom`, `recharts`, `rehype-sanitize`, `remark-gfm`, `sonner`, `swr`, `tailwind-merge`, `tailwindcss-animate`, `@tanstack/react-query`, `@types/d3`, `vaul`, `vis-timeline`, `vite-plugin-pwa`, `zod`, `zustand`?**
  _High betweenness centrality (0.098) - this node is a cross-community bridge._
- **Why does `react` connect `react` to `dependencies`, `hooks/use-toast.ts`, `WhatIfSliderPanel.tsx`?**
  _High betweenness centrality (0.065) - this node is a cross-community bridge._
- **Why does `cn()` connect `cn` to `card.tsx`, `CardHeader`, `Navigation.tsx`, `useLocale`, `Theories.tsx`, `tooltip.tsx`, `useThemeStore`, `hooks/use-toast.ts`, `DependencyGraph.tsx`, `utils.ts`, `button.tsx`, `MySymbols.tsx`, `badge.tsx`, `breadcrumb.tsx`, `drawer.tsx`, `SubmissionWizard.tsx`, `Profile.tsx`, `ForecastEventCard.tsx`, `toggle-group.tsx`, `InteractiveTimeline.tsx`, `dialog.tsx`, `forecasts-api.ts`, `WhatIfSliderPanel.tsx`, `sidebar.tsx`, `input-otp.tsx`, `ForecastEvent`, `MarketComparisonSection.tsx`, `IntelHub.tsx`, `CartDrawer.tsx`, `avatar.tsx`, `TrialDetailModal.tsx`, `NavLink.tsx`, `DependencyRule`, `skeleton.tsx`, `useModeStore`, `MarketOverlayTimeline.tsx`, `CoWitnessSettings.tsx`, `SaveButton.tsx`, `WhatIfTimeline.tsx`, `MegaMenu.tsx`, `useSymbolVoting.tsx`, `Auth.tsx`, `GuideDetail.tsx`, `carousel.tsx`, `UserDropdown.tsx`, `menubar.tsx`, `TimelineVisualization.tsx`, `command.tsx`, `HorizontalBarTimeline.tsx`, `chart.tsx`, `context-menu.tsx`?**
  _High betweenness centrality (0.054) - this node is a cross-community bridge._
- **What connects `$schema`, `style`, `rsc` to the rest of the system?**
  _1602 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `Communities (280 total, 98 thin omitted)` be split into smaller, more focused modules?**
