# Graph Report - dmtcode  (2026-09-13)

## Corpus Check
- 609 files · ~861,337 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3488 nodes · 7523 edges · 283 communities (185 shown, 98 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 24 edges (avg confidence: 0.61)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9975450a`
...
- Graph Report - dmtcode  (2026-09-12)
- devDependencies
- renderArticleDetail
- entries
...
1. `Communities (281 total, 99 thin omitted)` - 171 edges
2. `cn()` - 150 edges
3. `Button` - 144 edges
...
## Communities (283 total, 98 thin omitted)

### Community 0 - "Communities (281 total, 99 thin omitted)"
Cohesion: 0.01
Nodes (171): Communities (281 total, 99 thin omitted), Community 0 - "Communities (274 total, 97 thin omitted)", Community 100 - "check-docs-drift.mjs", Community 101 - "RegistryDoor.tsx", Community 102 - "SymbolResponsePanel.tsx", Community 103 - "menubar.tsx", Community 104 - "toast.tsx", Community 105 - "calculate-cascade/index.ts" (+163 more)
...
### Community 48 - "TrialDetailModal.tsx"
Cohesion: 0.14
...
Cohesion: 0.15
Nodes (12): formatLocation(), RetreatCard(), Retreat, hasAnyTag(), NULL_REPORT_TAGS, ProfileData, RegistryBrowser(), SOBER_TAGS (+4 more)

### Community 67 - "DependencyRule"
Cohesion: 0.17
...
### Community 78 - "hydration-parity.mjs"
Cohesion: 0.24
...
### Community 85 - "CoWitnessSettings.tsx"
Cohesion: 0.22
...
### Community 88 - "WhatIfTimeline.tsx"
Cohesion: 0.21
...
### Community 90 - "useSymbolVoting.tsx"
Cohesion: 0.19
...
### Community 96 - "timeline.schema.json"
Cohesion: 0.15
...
### Community 104 - "check-docs-drift.mjs"
Cohesion: 0.18
...
### Community 110 - "Graph Report - dmtcode  (2026-09-12)"
Cohesion: 0.18
Nodes (10): Community Hubs (Navigation), Corpus Check, God Nodes (most connected - your core abstractions), Graph Freshness, Graph Report - dmtcode  (2026-09-12), Import Cycles, Knowledge Gaps, Suggested Questions (+2 more)

### Community 111 - "devDependencies"
Cohesion: 0.18
Nodes (11): eslint-plugin-react-refresh, lovable-tagger, devDependencies, eslint-plugin-react-refresh, lovable-tagger, postcss, @types/react, vite (+3 more)
...
### Community 132 - "TrialsTimeline.tsx"
Cohesion: 0.28
Nodes (7): TrialDetailModal(), ClinicalTrial, statusColors, TrialsTimeline(), SharedTimeline(), SharedTimelineProps, TimelineItem
...
- **Why does `cn()` connect `cn` to `card.tsx`, `CardHeader`, `Navigation.tsx`, `useLocale`, `Theories.tsx`, `tooltip.tsx`, `useThemeStore`, `hooks/use-toast.ts`, `DependencyGraph.tsx`, `utils.ts`, `button.tsx`, `MySymbols.tsx`, `badge.tsx`, `breadcrumb.tsx`, `drawer.tsx`, `SubmissionWizard.tsx`, `Profile.tsx`, `ForecastEventCard.tsx`, `toggle-group.tsx`, `InteractiveTimeline.tsx`, `dialog.tsx`, `forecasts-api.ts`, `WhatIfSliderPanel.tsx`, `sidebar.tsx`, `input-otp.tsx`, `ForecastEvent`, `MarketComparisonSection.tsx`, `IntelHub.tsx`, `avatar.tsx`, `CartDrawer.tsx`, `TrialDetailModal.tsx`, `NavLink.tsx`, `skeleton.tsx`, `DependencyRule`, `useModeStore`, `MarketOverlayTimeline.tsx`, `CoWitnessSettings.tsx`, `SaveButton.tsx`, `WhatIfTimeline.tsx`, `MegaMenu.tsx`, `useSymbolVoting.tsx`, `Auth.tsx`, `GuideDetail.tsx`, `carousel.tsx`, `UserDropdown.tsx`, `menubar.tsx`, `TimelineVisualization.tsx`, `command.tsx`, `HorizontalBarTimeline.tsx`, `chart.tsx`, `context-menu.tsx`?**
  _High betweenness centrality (0.054) - this node is a cross-community bridge._
- **What connects `$schema`, `style`, `rsc` to the rest of the system?**
  _1602 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `Communities (281 total, 99 thin omitted)` be split into smaller, more focused modules?**
