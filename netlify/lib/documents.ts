...
//
// MIRROR. Edge functions cannot import from src/, so this is a hand copy of
// src/data/documents.ts. Edit that file first, then copy the DOCUMENTS array
// verbatim into this one.
