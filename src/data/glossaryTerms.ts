...
export const terms: GlossaryTerm[] = [
  ...
  {
    term: "Form Constant",
    definition: "Recurring geometric pattern (tunnels, spirals, honeycombs, lattices) observed across diverse altered states, generally attributed to primary visual cortex (V1) architecture. Distinguished from the discrete alphabetic-like symbols reported under the 650 nm laser protocol, which are described as bounded character-like elements rather than continuous geometric fields."
  }
];

// Duplicated verbatim in netlify/edge-functions/content-prerender.ts because Netlify
// edge functions run in Deno and cannot import from src/. This file is the source of truth.
