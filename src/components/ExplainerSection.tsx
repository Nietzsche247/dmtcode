  ...
  return (
    <section id="explainer" className="relative py-20 px-4">
      <div className="max-w-4xl mx-auto space-y-8">
        <h2 className="text-4xl md:text-5xl font-helvetica font-bold text-center mb-12">
          Key Takeaways
        </h2>
        
        <Card className="p-8 md:p-12 bg-card border-border glow-border">
          <div className="prose prose-invert max-w-none space-y-6 font-garamond">
