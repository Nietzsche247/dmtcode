...
const Tools = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Elite Journey Arsenal - DMT Code Tools & Equipment</title>
        <meta 
          name="description" 
          content="Curated 650nm protocol equipment from $12 impulse sparks to $1,999 whale transformations. Goler 2025 verified. Affordable entry to luxury psychedelic journey gifts." 
        />
        <link rel="canonical" href="https://dmtcode.com/tools" />
        <meta name="keywords" content="affordable psychedelic journey merch, DMT laser tools, biohacking equipment, psychedelic gifts" />
            ...
            <section className="px-4 py-16 bg-gradient-to-b from-background via-muted/20 to-background">
              <div className="max-w-5xl mx-auto text-center space-y-6">
                ...
                <h1 className="text-4xl md:text-6xl font-bold glow-text leading-tight">
                  ...
                  <span className="text-primary">From Impulse Sparks to Whale Transformations</span>
                </h1>
                
                <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                  Ranked lowest-to-highest price. Affluent-to-impulse flow—$12 talismans to $1,999 clinical-grade prep systems. 
                  Every item ties to peer-reviewed research (Goler 2025, Strassman 2001, Timmermann 2019).
                </p>

                <div className="pt-4 space-y-3">
                  <p className="text-sm text-muted-foreground">
                    <span className="font-semibold text-foreground">Currently Sold Out:</span> All tiers restocking Q1 2025
                  </p>
                  <Button 
                    size="lg" 
              ...
              <div className="max-w-7xl mx-auto space-y-12">
                <div className="text-center space-y-4">
                  <h2 className="text-3xl md:text-4xl font-bold">
                    Ranked Arsenal: $12 → $1,999
                  </h2>
                  <p className="text-muted-foreground max-w-2xl mx-auto">
                    Research-backed equipment for every budget. Sold out items fund ongoing decoding research.
                  </p>
                </div>
