...
const WooProductDetail = () => {
      ...
      <div className="min-h-screen bg-background">
        ...
        <main className="container mx-auto px-4 py-20">
          <div className="text-center">
            ...
            <Link to="/community/woo">
              <Button variant="outline">
                <ArrowLeft className="w-4 h-4 mr-2" />
                Back to Mysticism Store
              </Button>
            </Link>
          </div>
        </main>
  ...
  const relatedItems = Object.values(wooProducts)
  ...
  const handleAddToCart = () => {
    addItem({
      ...
      variantId: `woo-item-variant-${item.slug}`,
  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        <title>{item.title} | DMT Code Mysticism Store</title>
      ...
      <main id="main-content" tabIndex={-1} className="container mx-auto px-4 py-8">
        ...
        <nav className="mb-8">
          ...
          >
            ...
            <span className="text-sm font-light">Back to Mysticism Store</span>
          </Link>
        </nav>
        ...
        <div className="grid lg:grid-cols-2 gap-12 mb-16 animate-fade-in">
          ...
          <div className="flex flex-col">
            <Badge variant="outline" className="w-fit mb-4 text-xs font-light border-primary/30">
              {item.category}
            </Badge>
            
            <h1 className="text-4xl lg:text-5xl font-black tracking-tight mb-4 bg-gradient-to-r from-foreground to-foreground/70 bg-clip-text">
              {item.title}
            </h1>
            ...
            <Button 
              ...
              className="w-full lg:w-auto px-12 py-6 text-lg font-semibold mb-6 group"
            >
            ...
            {item.relatedResearch && item.relatedResearch.length > 0 && (
              <div className="flex items-center gap-2 text-sm text-muted-foreground">
                ...
                <span className="font-light">Connections in: {item.relatedResearch.join(', ')}</span>
              </div>
            )}
          </div>
        </div>
        ...
        {relatedItems.length > 0 && (
          <section className="mb-16 animate-fade-in" style={{ animationDelay: '0.3s' }}>
            <h2 className="text-2xl font-black mb-2">Related Items</h2>
