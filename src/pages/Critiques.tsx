          ...
          <section className="container mx-auto px-4 py-16 max-w-4xl">
            ...
            <Card className="p-8 bg-card border-border mb-8">
              <h2 className="text-2xl font-semibold mb-4">
                ...
                >
                  1) Laser speckle (Andrew Gallimore)
                </a>
              </h2>
            ...
            <Card className="p-8 bg-card border-border mb-8">
              <h2 className="text-2xl font-semibold mb-4">
                <a
                  href="https://x.com/algekalipso/status/1865112324178350236"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="hover:underline"
                >
                  2) Cymatics (Andres Gomez Emilsson)
                </a>
              </h2>
              <p className="text-base leading-relaxed mb-4">
            ...
            <Card className="p-8 bg-muted/30 border-border">
              ...
              <p className="text-base leading-relaxed">
                ...
                could distinguish them. Every symbol carries the metadata its contributor supplied. Stance scores exist for
