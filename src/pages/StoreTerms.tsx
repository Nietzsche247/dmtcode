        ...
        <main id="main-content" className="relative z-10 pt-4" role="main">
          <section className="container mx-auto px-4 py-16 max-w-4xl">
            ...
            <div className="space-y-6 text-base leading-relaxed">
              ...
              <p>All product names, printed observation materials, and site content are the property of Meridian Optics Lab or its licensors and may not be reproduced for commercial purposes without written permission.</p>
