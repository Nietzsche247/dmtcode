          ...
          {products.length > 0 && (
            <section className="mt-20 max-w-4xl mx-auto border-t border-border pt-16">
              ...
              <div className="prose prose-invert max-w-none">
                ...
                <p className="text-lg text-muted-foreground leading-relaxed mb-6">
                  Correlations: DMT reports sometimes describe an "instructional" emotional quality that mirrors Kabbalah's letter permutations for "conjuring" (unverifiable, but symbolic numerology and gematria offer math patterns for tool tags). Explore these products to test connections, and upload symbols from rituals to <a href="/registry" className="text-primary hover:underline">/registry</a> for community decode.
                </p>
